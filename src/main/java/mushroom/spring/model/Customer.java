...
public class Customer {
	...
	/**
	 * This constructs a customer with specified first name, last name, email, address
	 * phone number, password, postcode and type.
	 * 
	 * @param customer_first_name the customers first name
	 * @param customer_last_name the customers last name
	 * @param customer_email the customers email
	 * @param customer_address the customers address
	 * @param customer_phone_number the customers phone number
	 * @param customer_password the customers password
	 * @param customer_postcode the customers postcode
	 ...
	 * 
	 * @param customer_id the customers ID 
	 */
